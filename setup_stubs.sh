...
# Objeto C++ simulado con todas las firmas de optimización SPIRV
...
# Dejamos cross.txt simplificado apuntando únicamente al inyector vk_pc_stubs.h que ahora contiene todo el kit de Zstd y Zlib
