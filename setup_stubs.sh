...
# 1. Cabeceras biónicas del preprocesador de Android obligatorias de fábrica
...
# 2. INYECTOR DE FIRMAS COMPLETAS Y REALES DE LINUX (Evita fallos de compress.c y syncobj)
