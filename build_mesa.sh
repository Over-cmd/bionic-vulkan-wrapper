...
echo "=== 1. Aplicando parche de conversión de punteros de 64 a 32 bits (Macro de leegao) ==="
# El truco maestro definitivo: Forzamos el casteo explícito (void*)(uintptr_t)(handle) dentro de la macro TRACK_STAGING 
# Esto destruye el error de conversión incompatible en la linea 1406 de wrapper_device.c de forma global
...
echo "=== 3. Creando cabecera de compatibilidad bits/pthreadtypes.h ==="
touch local_include/bits/pthreadtypes.h

echo "=== 4. Inyectando cabecera xf86drm.h definitiva con estructuras de PC reales ==="
...
echo "=== 5. Generando descriptores de control .pc ==="
...
echo "=== 6. Configurando ETAPA 1: 32 BITS ==="
...
echo "=== 7. Configurando ETAPA 2: 64 BITS (Truco Pipetto) ==="
