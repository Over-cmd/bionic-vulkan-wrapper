...
# BLOQUEO DE STRIP: Colocamos /bin/true para retener el peso original completo
...
echo "Verificando el tamaño bruto real y pesado del driver original:"
