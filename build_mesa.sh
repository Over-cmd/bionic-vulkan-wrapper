...
# Compilamos de forma legítima el optimizador pesado de leegao con el NDK r25c
...
# COPIADO QUIRÚRGICO DE SEGURIDAD: Inyectamos los archivos .a pesados reales en las dos rutas que Meson inspecciona por defecto
