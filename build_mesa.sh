...
echo "=== 1. Inyectando cabecera xf86drm.h definitiva con tipado de dispositivos ==="
# Incluimos primero drm.h de Mesa e inyectamos los tipos drmDevice, drmDevicePtr y la firma drmGetDevices2 que exige vk_instance.c
