...
# El truco: Limpiamos c_link_args dejando solo -L para que Meson no busque archivos en la carpeta equivocada del NDK
...
# Pasamos local_drm_stubs.c de forma física inyectándolo en las variables LDFLAGS de Bash para el cierre final del .so
