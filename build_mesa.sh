...
# MAPEO DE RUTAS NATIVAS: Apuntamos exactamente a la carpeta de la API 26 donde Google guarda libdl y librt físicas
NDK_LIB_DIR_64="$NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/26"

echo "=== 2. Configurando COMPILACIÓN DE MESA: ANDROID NDK25 ==="
# Inyectamos de forma obligatoria las carpetas de la API 26 en la propiedad lib_dirs de Meson para resolver find_library('dl')
