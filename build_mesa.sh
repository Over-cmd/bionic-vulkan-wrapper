...
echo "=== 1. Inyectando cabecera xf86drm.h definitiva con todas las firmas de control ==="
# Incluimos primero drm.h de Mesa y agregamos drmSyncobjSignal y drmSyncobjReset exigidas por vk_drm_syncobj.c
