...
# INYECCIÓN REGLAMENTARIA DE BITS: Pasamos la orden de succionar libadrenotools.a directamente en los link_args del cross-file usando la sintaxis de búsqueda de subproyectos de Meson
