...
# BYPASS TOTAL: Inyectamos en [properties] las dependencias nulas de dl y rt para que Meson no corra find_library() en el core del build system
...
# El secreto definitivo: Añadimos stubs en blanco de dl y rt al descriptor .pc de control para silenciar las peticiones secundarias de las macros
printf "Name: dl\nDescription: Override\nVersion: 1.0\nLibs:\n" > local_pkgconfig/dl.pc
printf "Name: rt\nDescription: Override\nVersion: 1.0\nLibs:\n" > local_pkgconfig/rt.pc
...
# Aplicamos la misma inyección de propiedades limpias para la Etapa 2 de 64 bits
