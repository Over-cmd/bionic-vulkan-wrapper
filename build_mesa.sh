...
echo "=== 1. Inyectando cabecera xf86drm.h completa definitiva ==="
...
echo "=== 3. Configurando ETAPA 1: 32 BITS (Elevado a API 26 para sync_merge) ==="
...
echo "=== 4. Configurando ETAPA 2: 64 BITS (Truco Pipetto a API 26) ==="
