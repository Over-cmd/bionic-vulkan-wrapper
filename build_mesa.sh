...
echo "=== 3. Inyectando cabecera xf86drm.h definitiva con drmIoctl ==="
# Incluimos drm.h de Mesa, definimos las estructuras del bus e inyectamos la firma drmIoctl que pide wsi_common_drm.c
