...
# Restauramos los fuentes por si quedaron restos de parches anteriores
...
# Invocamos la orden de reparto limpia sobre el archivo físico final .c justo después del setup
python3 parchar_wsi.py
...
# Invocamos la misma orden sobre el carril hermano de 32 bits
python3 parchar_wsi.py
