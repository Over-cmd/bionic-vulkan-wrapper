...
# CORRECCIÓN MAESTRA: Cambiamos armv7a-linux-androideabi25-clang++ por androideabi26-clang++ para unificar la API 26 y pasar el test
...
# Unificamos también a la API 26 en la sección de 64 bits para dejar todo el entorno blindado
