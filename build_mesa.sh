...
echo "=== 4. Configurando COMPILACIÓN DE MESA: FIRMA BIÓNICA NATIVA ==="
SYSROOT_PATH="$NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/sysroot"

# LA PISTA DE DESPEGUE: Ponemos system = 'android' para inyectar los stubs reales de Google y evitar errores de símbolos perdidos al final
...
echo "=== 5. EMPAQUETADO BRUTO ESTRUCTURADO PARA STEVEN MXZ ==="
