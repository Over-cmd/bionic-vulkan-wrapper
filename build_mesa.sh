...
# INYECCIÓN MONOLÍTICA DE ENLAZADO EN 32 BITS: Metemos las librerías físicas reales del NDK mediante LDFLAGS globales de Meson
...
# INYECCIÓN MONOLÍTICA DE ENLAZADO EN 64 BITS: Metemos las librerías físicas reales del NDK mediante LDFLAGS globales de Meson
