...
echo "=== 2. Configurando COMPILACIÓN DE MESA: 64 BITS MONOLÍTICO ==="
# INYECCIÓN PURA DE BITS: Inyectamos '-Dffs=__builtin_ffs' y '-Dffsll=__builtin_ffsll' directamente en las opciones de Meson
# Esto ordena a Clang mapear los hilos matemáticos sin tocar bitscan.c, destruyendo la colisión del NDK 29
