...
# EL TRUCO BRUTO DE ANULACIÓN: Pasamos las banderas de preprocesador directo en las variables de compilacion globales de Linux
# para forzar de forma nativa que Meson ignore los checks de librerias externas obsoletas en Android
export LDFLAGS="-L$CLANG_LIB_DIR -L$NDK_LIB_DIR_32 -Wl,--no-fatal-warnings"
export CXXFLAGS="-I$BASE_PWD/spirv_source/include -I$BASE_PWD/local_include -Wno-format -D__BIONIC__"
export CFLAGS="-I$BASE_PWD/local_include -Wno-format -D__BIONIC__"
