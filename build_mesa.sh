...
# Invocamos la orden de reparto limpia sobre las carpetas vivas generadas por el setup
...
# Invocamos la misma orden sobre el carril simetrico de 32 bits recien generado
python3 parchar_wsi.py
