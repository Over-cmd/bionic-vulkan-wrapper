...
# EL TRUCO DEL PESO MÁXIMO EN 32 BITS: Forzamos la inyección física masiva del motor estático real de Khronos
...
# EL TRUCO DEL PESO MÁXIMO EN 64 BITS: Obligamos al enlazador a meter de forma física todos los megabytes de SPIRV-Tools reales adentro de tu libvulkan_wrapper.so definitivo de Winlator
