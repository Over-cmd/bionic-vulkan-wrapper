...
# ==============================================================================
# SINCRO DE FACTORÍA: Apuntamos glslangValidator a '/usr/bin/glslangValidator' para que Meson use el motor nativo lícito de PC en la nube, cerrando la línea 139 sin baches de arquitectura
