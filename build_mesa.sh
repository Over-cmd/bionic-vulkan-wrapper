...
echo "=== 3. Inyectando cabecera xf86drm.h definitiva con drmDevicesEqual ==="
# Incluimos drm.h de Mesa, definimos el bus e inyectamos drmDevicesEqual y los tipos DRM_BUS que pide wsi_common_drm.c
