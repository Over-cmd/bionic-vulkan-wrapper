...
echo "=== 3. Inyectando cabecera xf86drm.h definitiva con drmGetDevice2 ==="
# Incluimos drm.h de Mesa, definimos el bus e inyectamos drmGetDevice2 que pide wsi_common_drm.c en la linea 424
