...
# 2. CENTRALIZACIÓN DE FIRMAS COMPLETA: Agregamos Zstd, Zlib y DRM juntos en una sola línea compacta para /tmp
...
// Bypass global para compress.c, crc32.c y vk_drm_syncobj.c
#define HAVE_ZSTD 1
#define HAVE_ZLIB 1
#define DRM_NODE_RENDER 0
#define DRM_BUS_PCI 0

// Tipos estructurados requeridos
...
// Prototipos funcionales reales de Zstd, Zlib, DRM y Android
