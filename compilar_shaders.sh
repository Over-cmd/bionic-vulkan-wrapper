...
cmake .. -G Ninja -DCMAKE_TOOLCHAIN_FILE="$NDK_PATH/build/cmake/android.toolchain.cmake" -DANDROID_ABI=armeabi-v7a -DANDROID_ARM_NEON=ON -DANDROID_PLATFORM=android-26 -DCMAKE_BUILD_TYPE=Release -DSPIRV_WERROR=OFF -DCMAKE_C_FLAGS="-w -march=armv7-a -mfpu=neon" -DCMAKE_CXX_FLAGS="-w -march=armv7-a -mfpu=neon"
ninja -j $NPROC_CORES && cd ../..
...
cmake .. -G Ninja -DCMAKE_TOOLCHAIN_FILE="$NDK_PATH/build/cmake/android.toolchain.cmake" -DANDROID_ABI=armeabi-v7a -DANDROID_ARM_NEON=ON -DANDROID_PLATFORM=android-26 -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_FLAGS="-w -march=armv7-a -mfpu=neon" -DCMAKE_CXX_FLAGS="-w -march=armv7-a -mfpu=neon"
ninja -j $NPROC_CORES && cd ../..
