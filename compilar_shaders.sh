...
# Descarga del compilador glslang oficial de Khronos exigido por Mesa
...
# FORJA DE COMPONENTES DE SHADERS DE 64 BITS (324 pasos originales completos)
...
# FORJA DE GLSLANG DE 64 BITS COMPLETO
...
# FORJA DE COMPONENTES DE SHADERS DE 32 BITS (324 pasos originales completos)
...
# FORJA DE GLSLANG DE 32 BITS COMPLETO
