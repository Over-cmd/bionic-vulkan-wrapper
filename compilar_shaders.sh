#!/bin/bash
set -e
echo "=== ETAPA C-1: PRECOMPILACIÓN DE SHADERS LEEGAO ==="
...
# Parche de Khronos para el operador de texturas móviles 125
...
# Aligeramos el CMakeLists de leegao para apagar los tests redundantes de PC
...
echo "=== SHADERS CON PARCHE 125 COMPLETADOS EN EL DISCO ==="
