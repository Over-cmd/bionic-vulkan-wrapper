...
# 4. RESTAURACIÓN ABSOLUTA: Forzamos a git a devolver wsi_common_ahardware_buffer.c a su estado 100% real de fábrica para que compile su código original completo
if [ -f "src/vulkan/wsi/wsi_common_ahardware_buffer.c" ] || [ -f "src/vulkan/wsi/wsi_common.h" ]; then
  echo "-> Restaurando archivos WSI a su estado original de fabrica..."
...
echo "=== ENTORNO ENLAZADOR TOTALMENTE SINCRO DE FACTORÍA ==="
