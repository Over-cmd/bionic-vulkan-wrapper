...
c_link_args = ['-target', 'armv7a-linux-androideabi26', '-L$NDK_LIB_DIR_32', '-lc', '-llog', '-landroid', '-ldl']
cpp_link_args = ['-target', 'armv7a-linux-androideabi26', '-L$NDK_LIB_DIR_32', '-lc', '-llog', '-landroid', '-ldl']
[host_machine]
system = 'android'
cpu_family = 'arm'
cpu = 'armv7-a'
