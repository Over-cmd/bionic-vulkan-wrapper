...
# 1. Carpetas y blindaje xf86drm.h (Firma original de factoría limpia)
...
# 2. Bypass pthreads, guarda vulkan y restaurar Pkg-Config (Purificación Completa Real)
...
# RECTIFICACIÓN DEFINITIVA LIBCLC: Purgamos extprefix por completo dejando la ruta Unix lícita original
...
glslangValidator = '/usr/bin/glslangValidator'
[built-in options]
c_args = ['-w', '-D_GNU_SOURCE', '-I$BASE_PWD/local_include', '-I$BASE_PWD/local_include/libdrm', '-I$BASE_PWD/spirv_source/include', '-I$BASE_PWD/glslang_source', '-I$BASE_PWD/adrenotools_source/include', '-march=armv7-a', '-mfpu=neon', '-I$SYSROOT_PATH/usr/include']
cpp_args = ['-w', '-D_GNU_SOURCE', '-I$BASE_PWD/local_include', '-I$BASE_PWD/local_include/libdrm', '-I$BASE_PWD/spirv_source/include', '-I$BASE_PWD/glslang_source', '-I$BASE_PWD/adrenotools_source/include', '-march=armv7-a', '-mfpu=neon', '-I$SYSROOT_PATH/usr/include']
